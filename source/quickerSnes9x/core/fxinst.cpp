...
static void fx_to_r14(void) { FX_TO_R14(14); }

static void fx_to_r15(void) { FX_TO_R15(15); }
...
static void fx_link_i1(void) { FX_LINK_I(1); }

static void fx_link_i2(void) { FX_LINK_I(2); }

static void fx_link_i3(void) { FX_LINK_I(3); }

static void fx_link_i4(void) { FX_LINK_I(4); }
...
uint32 fx_run(uint32 nInstructions)
{
  ...
  READR14;
  while (TF(G) && (GSU.vCounter-- > 0)) FX_STEP;
#if 0
