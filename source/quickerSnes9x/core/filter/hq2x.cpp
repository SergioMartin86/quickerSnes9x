...
#define Interp01(c1, c2) (c1 == c2) ? c1 : (((((c1 & Mask_2) * 3 + (c2 & Mask_2)) >> 2) & Mask_2) + ((((c1 & Mask13) * 3 + (c2 & Mask13)) >> 2) & Mask13))

#define Interp02(c1, c2, c3) (((((c1 & Mask_2) * 2 + (c2 & Mask_2) + (c3 & Mask_2)) >> 2) & Mask_2) + ((((c1 & Mask13) * 2 + (c2 & Mask13) + (c3 & Mask13)) >> 2) & Mask13))

#define Interp03(c1, c2) (c1 == c2) ? c1 : (((((c1 & Mask_2) * 7 + (c2 & Mask_2)) >> 3) & Mask_2) + ((((c1 & Mask13) * 7 + (c2 & Mask13)) >> 3) & Mask13))

#define Interp04(c1, c2, c3)                                                                                                                                                       \
  (((((c1 & Mask_2) * 2 + (c2 & Mask_2) * 7 + (c3 & Mask_2) * 7) >> 4) & Mask_2) + ((((c1 & Mask13) * 2 + (c2 & Mask13) * 7 + (c3 & Mask13) * 7) >> 4) & Mask13))

#define Interp05(c1, c2) (c1 == c2) ? c1 : (((((c1 & Mask_2) + (c2 & Mask_2)) >> 1) & Mask_2) + ((((c1 & Mask13) + (c2 & Mask13)) >> 1) & Mask13))

#define Interp06(c1, c2, c3) (((((c1 & Mask_2) * 5 + (c2 & Mask_2) * 2 + (c3 & Mask_2)) >> 3) & Mask_2) + ((((c1 & Mask13) * 5 + (c2 & Mask13) * 2 + (c3 & Mask13)) >> 3) & Mask13))

#define Interp07(c1, c2, c3) (((((c1 & Mask_2) * 6 + (c2 & Mask_2) + (c3 & Mask_2)) >> 3) & Mask_2) + ((((c1 & Mask13) * 6 + (c2 & Mask13) + (c3 & Mask13)) >> 3) & Mask13))

#define Interp08(c1, c2) (c1 == c2) ? c1 : (((((c1 & Mask_2) * 5 + (c2 & Mask_2) * 3) >> 3) & Mask_2) + ((((c1 & Mask13) * 5 + (c2 & Mask13) * 3) >> 3) & Mask13))

#define Interp09(c1, c2, c3)                                                                                                                                                       \
  (((((c1 & Mask_2) * 2 + (c2 & Mask_2) * 3 + (c3 & Mask_2) * 3) >> 3) & Mask_2) + ((((c1 & Mask13) * 2 + (c2 & Mask13) * 3 + (c3 & Mask13) * 3) >> 3) & Mask13))

#define Interp10(c1, c2, c3) (((((c1 & Mask_2) * 14 + (c2 & Mask_2) + (c3 & Mask_2)) >> 4) & Mask_2) + ((((c1 & Mask13) * 14 + (c2 & Mask13) + (c3 & Mask13)) >> 4) & Mask13))
...
#define Absolute(c) (!(c & (1 << 31)) ? c : (~c + 1))
