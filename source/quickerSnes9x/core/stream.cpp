...
fStream::fStream(FSTREAM f) { fp = f; }

fStream::~fStream(void) { return; }

int fStream::get_char(void) { return (GETC_FSTREAM(fp)); }

char *fStream::gets(char *buf, size_t len) { return (GETS_FSTREAM(buf, len, fp)); }

size_t fStream::read(void *buf, size_t len) { return (READ_FSTREAM(buf, len, fp)); }

size_t fStream::write(void *buf, size_t len) { return (WRITE_FSTREAM(buf, len, fp)); }

size_t fStream::pos(void) { return (FIND_FSTREAM(fp)); }
...
int fStream::revert(size_t from, size_t offset) { return (REVERT_FSTREAM(fp, offset, from)); }
...
unzStream::~unzStream(void) { return; }
...
// not supported
size_t unzStream::write(void *buf, size_t len) { return (0); }
...
// not supported
int unzStream::revert(size_t from, size_t offset) { return -1; }
...
memStream::~memStream(void) { return; }
...
size_t memStream::pos(void) { return msize - remaining; }

size_t memStream::size(void) { return msize; }

int memStream::revert(size_t from, size_t offset)
{
  size_t pos = from + offset;

  if (pos > msize) return -1;
...
nulStream::nulStream(void) { bytes_written = 0; }

nulStream::~nulStream(void) { return; }

int nulStream::get_char(void) { return 0; }
...
size_t nulStream::read(void *buf, size_t len) { return 0; }
...
size_t nulStream::pos(void) { return 0; }

size_t nulStream::size(void) { return bytes_written; }
...
void nulStream::closeStream() { delete this; }
