...
extern __thread struct SSettings      Settings;
extern __thread struct SCPUState      CPU;
extern __thread struct STimings       Timings;
extern __thread struct SSNESGameFixes SNESGameFixes;
extern __thread char                  String[513];
